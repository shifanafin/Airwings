...
<footer className="bg-blue-main mt-12">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://flowbite.com/" className="hover:underline">Lorem.</a>
                      </li>
                      <li>
                          <a href="https://tailwindcss.com/" className="hover:underline">lorem</a>
                      </li>
                  </ul>
              </div>
              <div>
